...
$attendance_ID = getAttendanceID($schedule_ID);
        ...
        **********************************************************/
        if (empty($_POST) === false && getToken('tokenConfirmSchedule') && empty($errors) && isSchedulingServicePerformed($_POST['schedule_id']) === false) {
            ...
            echo output_msgs("Status do agendamento alterado com sucesso!!");
        }
        ...
        **********************************************************/
        if (empty($_POST) === false && getToken('tokenConfirmDeleteSchedule') && empty($errors) && ($_GET["del"] === 'true')) {
            ...
            header("refresh: 2, usersdata.php?subpage=userviewer&data=".$_GET['data']."");
        } 
        elseif (empty($_POST) === false && getToken('tokenDeleteSchedule') && empty($errors) && ($_GET["del"])) {
            ...
            <form action='usersdata.php?subpage=schedulingEdit&data=".$_GET['data']."&scheduling=".$_GET['scheduling']."&del=true' method='POST'>
                ...
                <a href='usersdata.php?subpage=schedulingEdit&data=".$_GET['data']."&scheduling=".$_GET['scheduling']."'>
...
?>
        ...
        <form action="" method="POST" enctype='multipart/form-data'>
            ...
            <tr>
                ...
                <td colspan="2">R$ <input class="smallInputTxt" name="pay_value" value="<?php echo getPaymentValue($schedule_ID) ?>" <?php echo $disabled ?>></input></td>
            </tr>
