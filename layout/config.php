<?php
    ...
    $config['sqlUser'] = 'administrator'; // USUARIO DO MYSQL
	$config['sqlPassword'] = 'adm123!@#154p'; // SENHA DO MYSQL
	$config['sqlDatabase'] = 'podologiaDB0'; // NAME DA DATABASE DO MYSQL
	$config['sqlHost'] = 'localhost'; // HOST DO MYSQLa
